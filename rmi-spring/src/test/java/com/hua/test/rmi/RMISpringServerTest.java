...
@ContextConfiguration(locations = {"classpath:conf/xml/spring-rmi-server.xml"})
public final class RMISpringServerTest extends BaseTest {
	 ...
	 */
	@Test
	public void testSpringStartService() {
		try {
			...
			log.error("testSpringStartService =====> ", e);
		}
	}	
